...
export default function FooterCallToAction({ className = "" }: FooterCallToActionProps) {
  ...
  return (
    <div className={`w-full text-blue-900 border-t border-white pt-3 sm:pt-4 md:pt-5 lg:pt-5 xl:pt-6 2xl:pt-7 pb-3 sm:pb-4 md:pb-5 lg:pb-5 xl:pb-6 2xl:pb-7 bg-slate-50 ${className}`}>
