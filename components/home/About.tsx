    ...
    <section
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 md:mb-16">
          <h3 className="text-base sm:text-lg md:text-xl font-semibold text-blue-900 text-center mb-6 md:mb-8 max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <h3 className="text-base sm:text-lg md:text-xl font-semibold text-blue-900 text-center mb-8 md:mb-12">
            Built by Engineers. Trusted by Enterprises.
          </h3>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            {/* Who We Are */}
            <div>
              <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-blue-900 mb-4 md:mb-6">
                Who We Are
              </h3>
              ...
              <div className="space-y-4">
                {whyDifferent.map((item) => (
                  <div key={item.id} className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="text-base md:text-lg font-semibold text-blue-900 mb-1">
                        {item.title}
                      </h4>
