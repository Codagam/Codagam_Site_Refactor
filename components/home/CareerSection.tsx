...
export default function CareerSection() {
  return (
    <section
      id="career-section"
      className="py-6 sm:py-8 md:py-10 lg:py-12 xl:py-14 2xl:py-16 bg-slate-50 scroll-mt-[48px] min-[375px]:scroll-mt-[52px] sm:scroll-mt-[56px] lg:scroll-mt-[64px] xl:scroll-mt-[68px] w-full overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-5 md:px-6 lg:px-8 xl:px-8 w-full overflow-x-hidden">
        <div className="text-center mb-4 sm:mb-5 md:mb-6 w-full">
          <h2 className="text-3xl mb-2 sm:mb-3 md:mb-4 font-bold text-blue-900 wrap-break-word px-2 sm:px-0">
            Join our team
          </h2>
