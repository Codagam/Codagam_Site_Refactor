    ...
    <section
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-5 md:px-6 lg:px-8 xl:px-8 w-full">
        <div className="text-center mb-4 sm:mb-5 md:mb-6 w-full">
          <h2 className="text-xl min-[375px]:text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-2 sm:mb-3 md:mb-4 font-semibold text-blue-900 wrap-break-word px-2 sm:px-0">
            Join our team
          </h2>
