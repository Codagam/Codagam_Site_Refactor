...
export default function CareerSection() {
  return (
    <section
      id="career-section"
      className="rv relative border-t border-(--border) py-10 sm:py-12 md:py-14 lg:py-18 px-4 sm:px-5 md:px-6 lg:px-8 text-center scroll-mt-12 sm:scroll-mt-16 overflow-hidden"
      style={{
        background:
