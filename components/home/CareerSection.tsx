  ...
  return (
    <section
      ...
      <div className="relative z-10 mx-auto max-w-[1100px]">
        <h2 className="rv font-(--font-serif) text-[clamp(2rem,4vw,3.25rem)] tracking-tight text-white mb-4 [&_em]:italic [&_em]:font-light [&_em]:text-(--acc2)">
          Tell us what you&apos;re <em>building next.</em>
        </h2>
        <p className="rv text-[1.05rem] text-(--text-dim) leading-[1.6] max-w-[480px] mx-auto mb-10">
        ...
        <div className="rv flex flex-wrap gap-5 justify-center items-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 font-(--font-sans) text-[.9rem] text-(--text-dim) py-3 px-6 rounded-lg border border-(--border) hover:text-white hover:border-(--acc2) hover:bg-[rgba(91,141,238,.08)] transition-colors"
          >
            ✉ hello@codagam.com
          </a>
        </div>
