...
export default function CareerSection() {
  return (
    <section
      id="career-section"
      className="py-6 sm:py-7 md:py-8 lg:py-8 xl:py-9 2xl:py-10 bg-slate-50 scroll-mt-[56px] min-[375px]:scroll-mt-[60px] sm:scroll-mt-[64px] md:scroll-mt-[68px] lg:scroll-mt-[72px] xl:scroll-mt-[76px] 2xl:scroll-mt-[80px] w-full">
      <div className="max-w-7xl mx-auto px-3 xs:px-4 sm:px-5 md:px-6 lg:px-8 xl:px-8 2xl:px-10 w-full">
        <div className="text-center mb-4 sm:mb-5 md:mb-6 lg:mb-6 xl:mb-7 2xl:mb-8 w-full">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-4xl 2xl:text-4xl mb-3 sm:mb-3.5 md:mb-4 lg:mb-4 xl:mb-4.5 2xl:mb-5 font-bold text-blue-900 wrap-break-word px-2 sm:px-4 md:px-6">
            Join our team
          </h2>
